...
const data = [
  ...
  },
  {
    ...
    dist: ['Karaikal', 'Mahe', 'Pondicherry', 'Yanam'],
  },
  {
    state: 'Punjab (PB)',
    dist: [
  ...
  {
    state: 'Sikkim (SK)',
    dist: ['East Sikkim', 'North Sikkim', 'South Sikkim', 'West Sikkim'],
  },
  {
    state: 'Tamil Nadu (TN)',
    dist: [
    ...
    <>
      <View
        ...
        <Picker
          ...
          style={{height: 50, width: 280, backgroundColor: '#07009E'}}
          ...
          <View
            ...
            <Picker
              ...
              onValueChange={(itemValue, itemIndex) =>
                setSelectDistrict(itemValue)
              }>
              <Picker.Item label="SELECT CITY" value={null} />
              {data
                .find(state => state.state === selectState)
